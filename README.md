...
O projeto utiliza Python 3, Flask, Flask-SQLAlchemy, SQLite, HTML5, CSS3, Git e GitHub. O sistema permite cadastrar categorias, cadastrar produtos, registrar entradas e saídas de estoque, visualizar o histórico de movimentações e receber alertas de estoque baixo.
...
Após iniciar a aplicação, o sistema estará disponível em http://127.0.0.1:5000. Através da interface web é possível gerenciar categorias, produtos e movimentações de estoque, além de visualizar um dashboard com resumo geral e alertas de estoque baixo.
...
Este projeto foi desenvolvido com o objetivo de colocar em prática e aprimorar conhecimentos em desenvolvimento web com Python, Flask, SQLAlchemy, operações CRUD e controle de estoque.
