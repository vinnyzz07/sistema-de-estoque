...
Após iniciar a aplicação, o sistema estará disponível em http://127.0.0.1:5000. Através da interface web é possível gerenciar categorias, produtos e movimentações de estoque, além de visualizar um dashboard com resumo geral e alertas de estoque baixo. As rotas de API estão disponíveis em /api/produtos e /api/produtos/estoque-baixo.
